...
<html lang="es">
    ...
    <body>
        <header>
            <img src="../img/logoF1Blanco.png" alt="logoF1" id="logoHeader" srcset="../img/logoF1Blanco.png">
            <button id="botonUser" class="buttonHeaderUser" type="button">
                ...
                <span id="nomUser"><?php session_start();  echo isset($_SESSION["user"]) ? $_SESSION["user"] : "Sign In"; ?></span>
            </button>
        ...
        <main>
            ...
            <div id="banner">
                <img src="../img/hp-masthead-filler-web.svg" alt="" srcset="../img/hp-masthead-filler-web.svg">
                <img src="../img/f1-fantasy-white-logo.svg" id="logoEnBanner" alt="logoBanner" srcset="../img/f1-fantasy-white-logo.svg">
                <img src="../img/hp-masthead-thumb-web.png" id="pilotos" alt="" srcset="../img/hp-masthead-thumb-web.png">
        ...
        <footer class="container-fluid">
            ...
            <div class="row">
                <div id="logoFooter1" class="col-md-4">
                    <img src="../img/logoF1.png" alt="logoF1" id="logoFooter2" srcset="../img/logoF1.png">
                </div>
