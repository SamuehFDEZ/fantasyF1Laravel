...
class pilotosTableSeeder extends Seeder
{
    ...
    public function run()
    {
        $pilotos = [
            ...
            ['num_piloto' => 20, 'nombre' => 'Kevin Magnussen', 'valorMercado' => 6.7, 'puntosRealizados' => 1, 'fechaNac' => '1992-10-05', 'nacionalidad' => 'Dinamarca', 'userID' => null, 'nombre_constructor' => 'Hass'],
            ['num_piloto' => 27, 'nombre' => 'Nico Hülkenberg', 'valorMercado' => 6.2, 'puntosRealizados' => 3, 'fechaNac' => '1987-8-19', 'nacionalidad' => 'Alemania', 'userID' => null, 'nombre_constructor' => 'Hass'],
